...
def imageObject = CustomKeywords.'newKeyword.loopXpath.getTestObjectWithXpath'(imageFullXpath)
...
def nameObject = CustomKeywords.'newKeyword.loopXpath.getTestObjectWithXpath'(nameFullXpath)
def priceObject = CustomKeywords.'newKeyword.loopXpath.getTestObjectWithXpath'(priceFullXpath)
...
def cartNameObject = CustomKeywords.'newKeyword.loopXpath.getTestObjectWithXpath'(cartItemNameFullXpath)
def cartPriceObject = CustomKeywords.'newKeyword.loopXpath.getTestObjectWithXpath'(cartItemPriceXQtyFullXpath)
def cartSubTotalObject = CustomKeywords.'newKeyword.loopXpath.getTestObjectWithXpath'(cartSubTotalFullXpath)
...
while (currIdx < 4) {
	...
	// UPDATE TEST OBJECT
	// =============================================
    nameObject = CustomKeywords.'newKeyword.loopXpath.getTestObjectWithXpath'(nameFullXpath)
    priceObject = CustomKeywords.'newKeyword.loopXpath.getTestObjectWithXpath'(priceFullXpath)
    imageObject = CustomKeywords.'newKeyword.loopXpath.getTestObjectWithXpath'(priceFullXpath)
	
	cartNameObject = CustomKeywords.'newKeyword.loopXpath.getTestObjectWithXpath'(cartItemNameFullXpath)
	cartPriceObject = CustomKeywords.'newKeyword.loopXpath.getTestObjectWithXpath'(cartItemPriceXQtyFullXpath)
	cartSubTotalObject = CustomKeywords.'newKeyword.loopXpath.getTestObjectWithXpath'(cartSubTotalFullXpath)
}

WebUI.callTestCase(findTestCase('Application Start and Stop/Close application'), [:], FailureHandling.STOP_ON_FAILURE)
