...
Mobile.setText(findTestObject('Checkout/Body/android.widget.EditText'), 'zoro', 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.setText(findTestObject('Checkout/Body/android.widget.EditText - email'), 'zoro@gmail.com', 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.setText(findTestObject('Checkout/Body/android.widget.EditText address'), '5463453', 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.setText(findTestObject('Checkout/Body/android.widget.EditText - Your Address'), 'Street no 8', 0)
